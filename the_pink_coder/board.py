...
class Board:
    ...
    def update_available_throw(self):
        ...
        # Updating the avaliable throw choice based on it is upper player or lower player
    ...
    def generate_best_action(self, multi=True):
        ...
        # While it is in multi stage mode, it would look further of the action pair, have an insight of the future status
